 ...
 */
package app.proxime.users.management;
...
public abstract class DynamoDao<T> {
    ...
    protected DynamoDBMapper mapper = new DynamoDBMapper(client, new DynamoDBMapperConfig(new ResolvedorDeNombresParaTablasDynamo()));
    ...
    private boolean tableExists(){
        return true; //while logic is not implemented yet, assume that exists
